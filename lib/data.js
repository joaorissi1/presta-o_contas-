...
export const PC_DOMINIO = "@valonconsult.com.br";

export const PC_ROLES = {
  "SÓCIO DIRETOR": ["RELACIONAMENTO", "PESSOAS", "PROJETOS", "FINANCEIRO", "ADMINISTRATIVO"],
  "DIRETOR": ["RELACIONAMENTO", "PESSOAS", "PROJETOS"],
  "GERENTE": ["RELACIONAMENTO", "PESSOAS", "PROJETOS"],
  "SUPERVISOR": ["RELACIONAMENTO", "PESSOAS", "PROJETOS"],
  "CONSULTOR SENIOR": ["RELACIONAMENTO", "PESSOAS"],
  "CONSULTOR PLENO": ["RELACIONAMENTO", "PESSOAS"],
  "CONSULTOR JUNIOR": ["RELACIONAMENTO", "PESSOAS"],
  "TRAINEE": ["RELACIONAMENTO", "PESSOAS"],
  "COORDENADOR ADMINISTRATIVO": ["RELACIONAMENTO", "PESSOAS", "PROJETOS", "FINANCEIRO", "ADMINISTRATIVO"]
};
...
/* aprovação restrita: Branca Arioli, Fabrício La Gamba, Eduardo Rota */
export const PC_APROVADORES = ["branca.arioli", "fabricio.lagamba", "eduardo.rota"];
